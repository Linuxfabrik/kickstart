...
Preseed provides a way to set answers to questions asked during the Debian installation process, without having to manually enter the answers while the installation is running. This makes it possible to fully automate Debian installations. (`Source <https://wiki.debian.org/DebianInstaller/Preseed>`_)
...
* `Debian Preseed Documentation <https://www.debian.org/releases/stable/amd64/apb.en.html>`_
* `Debian Preseed Example <https://www.debian.org/releases/stable/example-preseed.txt>`_
...
* `Ubuntu Autoinstall Reference <https://canonical-subiquity.readthedocs-hosted.com/en/latest/reference/autoinstall-reference.html>`_
* `Ubuntu Autoinstall Quick Start <https://canonical-subiquity.readthedocs-hosted.com/en/latest/howto/autoinstall-quickstart.html>`_
